...
| [checkEquals](./checkEquals.js) | Arrays | Easy (est.) |  |
| [dashed](./dashed.js) | Strings | Easy (est.) |  |
...
| [isOrthogonal](./isOrthogonal.js) | Math | Easy (est.) |  |
| [isPandigital](./isPandigital.js) | Math | Easy (est.) |  |
...
Edabit does not publish per-problem ratings here; difficulty is estimated (all are introductory exercises).
...
cd problem-solving/Edabit-problemSolving
